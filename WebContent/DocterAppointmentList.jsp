...
<%
	...
	try{
		...
		while(rs.next()){
			...
			<%
			try{
				String sql2="SELECT tbl_tables.tbl_id, tbl_appoinment.intervels, tbl_appoinment.patient, tbl_appoinment.dsp FROM tbl_appoinment Inner Join tbl_tables ON tbl_tables.tbl_id = tbl_appoinment.tbl_id where tbl_tables.date='"+date+"' ";
